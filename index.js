...
// Exemplo de endpoint para comentar
app.post('/api/comentarios', async (req, res) => {
    ...
    try {
        ...
        return res.json({ success: true, comentario: novoComentario });
    } catch (error) {
        console.error('Erro ao adicionar comentário:', error);
        return res.json({ success: false, message: 'Erro ao adicionar comentário' });
    }
});
